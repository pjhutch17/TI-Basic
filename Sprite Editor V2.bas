       ...
       100 REM ** SPRITE Editor/Manager V2 28/02/2023 **
       110 CALL CLEAR
       120 OPTION BASE 1
       130 DIM G$(16,16),G2$(16,16),F$(20,2)
       ...
       170 DISPLAY AT(13,8)SIZE(18):"VERSION 2"
       ...
       382 IF C$="VFL" THEN GOSUB 2080 :: GOTO 240
       384 IF C$="HFL" THEN GOSUB 2220 :: GOTO 240
       386 IF C$="ROT" THEN GOSUB 2220 :: GOTO 240
       390 IF C$="EXI" THEN STOP
       400 DISPLAY AT(22,3):"NO SUCH COMMAND"
       410 GOTO 240
       420 FOR A=1 TO 16
       430 FOR B=1 TO 16 :: G$(A,B)="0" :: NEXT B
       ...
       640 RETURN
       650 RESTORE 700
       655 FOR A=3 TO 20 :: DISPLAY AT(A,18)SIZE(10):"          " :: NEXT A
       660 FOR A=5 TO 19
       670 READ L$
       680 DISPLAY AT(A,20)SIZE(9):L$
       690 NEXT A
       700 DATA HELP,COLOUR,CLEAR,STORE,INVERT,DISPLAY,DREFLECT,AREFLECT,SAV
       E,READ,REPLACE,EXIT,VFLIP,HFLIP,ROTATE
       710 RETURN
       720 GOSUB 1920 :: DISPLAY AT(22,1)SIZE(13):"FORE` COLOUR?"
       ...
       940 FOR K=8 TO 1 STEP -1 :: R=R+2^P*VAL(G$(B,K)):: P=P+1 :: NEXT K
       ...
       1260 FOR C=1 TO 16 :: G$(B,C)=SEG$(P$,C,1):: NEXT C
       1270 NEXT B
       1280 FOR B=1 TO 16
       1290 FOR C=1 TO 16
       1300 IF G$(B,C)="1" THEN CALL HCHAR(B+2,C+3,136)ELSE CALL HCHAR(B+2,C
       +3,128)
       1310 NEXT C
       1320 NEXT B
       1330 FOR B=1 TO 4
       ...
       1570 RETURN
       1580 CALL CLEAR :: GOSUB 2000
       1590 OPEN #1:FN$,INTERNAL,OUTPUT,VARIABLE 128
       1600 PRINT #1:FL
       ...
       1660 RETURN
       1670 CALL CLEAR :: GOSUB 2000
       1680 OPEN #1:FN$,INTERNAL,INPUT ,VARIABLE 128
       1690 INPUT #1:FL
       ...
       1910 RETURN
       1915 REM DISPLAY COLOUR NAMES
       1920 RESTORE 1970
       1930 FOR A=1 TO 16
       1940 READ L$
       1950 DISPLAY AT(A+2,18):A;L$
       1960 NEXT A
       1970 DATA TRANSP`T,BLACK,M.GREEN,L.GREEN,D.BLUE,L.BLUE,D.RED,CYAN
       1980 DATA M.RED,L.RED,D.YELL,L.YELL,D.GREEN,MAGENTA,GRAY,WHITE
       1990 RETURN
       2000 PRINT : :"1 TAPE (CS1)": :"2 DISK (DSK1)"
       2010 ACCEPT VALIDATE("12"):OPT
       2020 IF OPT=1 THEN FN$="CS1" :: RETURN
       2030 IF OPT<>2 THEN 2010
       2040 PRINT : : :"FILENAME?";:: ACCEPT FN$
       2050 FN$="DSK1."&FN$
       2060 RETURN
       2070 REM VERTICAL FLIP
       2080 FOR A=1 TO 16
       2090 FOR B=1 TO 16
       2100 G2$(17-A,B)=G$(A,B)
       2110 NEXT B
       2120 NEXT A
       2130 FOR A=1 TO 16
       2140 FOR B=1 TO 16
       2150 G$(A,B)=G2$(A,B)
       2160 IF G$(A,B)="0" THE CALL HCHAR(A+2,3+B,128)ELSE CALL HCHAR(A+2,3+
       B,136)
       2170 NEXT B
       2180 NEXT A
       2200 RETURN
       2210 REM HORIZONTAL FLIP
       2220 FOR B=1 TO 16
       2230 FOR A=1 TO 16
       2240 G2$(A,17-B)=G$(A,B)
       2250 NEXT A
       2260 NEXT B
       2270 FOR A=1 TO 16
       2280 FOR B=1 TO 16
       2290 G$(A,B)=G2$(A,B)
       2300 IF G$(A,B)="0" THE CALL HCHAR(A+2,3+B,128)ELSE CALL HCHAR(A+2,3+
       B,136)
       2310 NEXT B
       ...
       2320 NEXT A
       2330 RETURN
       2340 REM ROTATE CLOCKWISE 90 DEGREES
       2350 FOR A=1 TO 16
       2360 FOR B=1 TO 16
       2370 G2$(B,17-A)=G$(A,B)
       2380 NEXT B
       2390 NEXT A
       2400 FOR A=1 TO 16
       2410 FOR B=1 TO 16
       2420 G$(A,B)=G2$(A,B)
       2430 IF G$(A,B)="0" THE CALL HCHAR(A+2,3+B,128)ELSE CALL HCHAR(A+2,3+
       B,136)
       2440 NEXT B
       2450 NEXT A
       2460 RETURN